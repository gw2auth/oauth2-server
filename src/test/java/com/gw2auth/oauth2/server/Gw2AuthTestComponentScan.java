...
@ComponentScan(basePackageClasses = Application.class, excludeFilters = {
        @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = {SelfProxyRestConfiguration.class, Gw2ApiClientConfiguration.class, HazelcastHttpSessionConfiguration.class})
})
