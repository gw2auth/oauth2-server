...
public interface MetricCollector {
    ...
    void collectMetrics(String requestPath, MultiValueMap<String, String> requestQuery, HttpHeaders requestHeaders, ResponseEntity<Resource> response, Duration duration);
    void collectMetrics(String requestPath, MultiValueMap<String, String> requestQuery, HttpHeaders requestHeaders, Exception exc, Duration duration);
}
