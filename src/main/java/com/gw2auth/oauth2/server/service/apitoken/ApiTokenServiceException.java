...
public class ApiTokenServiceException extends Gw2AuthServiceException {
    ...
    public ApiTokenServiceException(String message) {
        super(message);
    }

    public ApiTokenServiceException(String message, HttpStatus proposedStatusCode) {
